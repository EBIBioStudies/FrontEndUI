...
<xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform"
    ...
    <xsl:template name="bs-content-section">
        <section class="alpha intro grid_24 omega">
            <h3>Your have selected a directory.</h3>
            <p class="center">We are working on making the directory contents available to you directly from
                BioStudies. <br/>
                Meanwhile, you can click on the link below to browse it from our FTP server.</p>

            <p/>
            <p id="ftp-link"><a href="{$url}"><xsl:value-of select="$url"/></a></p>
        </section>
