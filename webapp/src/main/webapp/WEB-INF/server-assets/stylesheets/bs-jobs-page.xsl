            ...
            <div id="wrapper" class="container_24">
                <header>
                    ...
                    <div id="local-masthead" class="masthead grid_24 nomenu"
                         style="background: #1d8086 url(//www.ebi.ac.uk/web_guidelines/images/banners/EBI_HOMEPAGE_Banner_2016.jpg) top right no-repeat; background-size: 100%; ">
                        <!-- local-title -->
                        <div id="local-title">
                            <h1>The European Bioinformatics Institute</h1>
                        </div>
                        <!-- /local-title -->
                        <!-- local-search -->
