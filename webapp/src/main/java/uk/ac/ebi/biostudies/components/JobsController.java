...
import uk.ac.ebi.biostudies.utils.controller.IJobsController;
import uk.ac.ebi.biostudies.jobs.*;
...
public class JobsController extends ApplicationComponent implements IJobsController {
    ...
    public void initialize() throws Exception {
        ...
        addJob("delete-temp-zip-files", DeleteTempZipFilesJob.class);
        ...
        scheduleJob("delete-temp-zip-files", "bs.files.temp-zip.delete");
