...
package uk.ac.ebi.biostudies.utils.saxon;
...
public class StoredDocument implements Document {
    ...
    private NodeInfo build(String xml) throws SaxonException {
        return Application.getAppComponent(SaxonEngine.class).buildDocument(xml);
    }

    private String serialize(NodeInfo rootNode) throws SaxonException {
        return Application.getAppComponent(SaxonEngine.class).serializeDocument(rootNode);
    }
